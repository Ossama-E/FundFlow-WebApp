...
const btnOpenModal = document.querySelector(".credentials--btn");
...
// Handling the list of usernames and passwords:
// List of Users and Pins Modal Helpers and Actions
const openModal = function (e) {
  e.preventDefault();
  credBox.style.position = "fixed";
...
function hideList() {
  credBox.classList.add("hidden");
  credBox.classList.remove("temporary--pos");
  overlay.classList.add("hidden");
}
...
// Attaching event listeners to the usernames button
